...
const paintRange = input => { input.style.removeProperty('background-image'); input.style.removeProperty('background-size'); input.style.removeProperty('background-position'); input.style.removeProperty('background-repeat'); input.style.setProperty('accent-color', 'var(--electric)'); };
