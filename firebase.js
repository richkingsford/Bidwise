...
const businessLogoUrl = value => { try { const host = new URL(String(value || '')).hostname; return host ? `https://www.google.com/s2/favicons?domain=${encodeURIComponent(host)}&sz=256` : ''; } catch { return ''; } };
